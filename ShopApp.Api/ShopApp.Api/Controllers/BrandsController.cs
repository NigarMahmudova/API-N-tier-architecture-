...
namespace ShopApp.Api.Controllers
{
    ...
    public class BrandsController : ControllerBase
    {
        ...
        {
            var brandDtos = _brandRepository.GetQueryable(x=>x.Products.Count>0).Select(x=>new BrandGetAllDto
            {
                Id = x.Id,
                Name = x.Name,
            }).ToList();
        ...
        [HttpPost("")]
        public IActionResult Post(BrandPostDto brandDto)
        {
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, BrandPutDto brandDto)
        {
            Brand brand = _brandRepository.Get(b => b.Id == id);
